...
const NavLinks = () => {
  ...
  return (
    <div className="flex flex-1 items-center relative">
      ...
      <div className="hidden md:flex md:w-[496px] md:h-[22px] items-center justify-between ml-auto">
        <Link
          to="/"
      ...
      {open && (
        <div className="fixed top-[-8px] right-[-30px] w-[320px] h-screen bg-[#111] text-[#d1d0d0] transform transition-transform duration-300  z-50 flex flex-col md:hidden">
          <div className="md:hidden flex items-center justify-between p-4 pt-[40px] mr-[24px]">
            <img src={Logo} alt="Logo-1" className="w-[100px] h-[34px]" />
          ...
          <div className="p-4">
            <Link
              to="/contact"
              onClick={() => setOpen(false)}
              className="block w-full bg-[#58595B] text-white rounded-[16px] text-[20px] py-3 text-center hover:shadow-[0px_4px_50px_0px_#FFFFFF80] transition-all duration-300 hover:bg-white hover:text-[#58595B]"
            >
              Contact Us
            </Link>
          </div>
